...
>
	<a
		class="flex flex-col text-white md:text-3xl font-bold m-3 select-none hover:bg-gray-800 rounded-xl"
		href={resolve('/')}
		draggable="false"
		onclick={() => {
	...
	>
		<div class="flex flex-row items-center">
			<img
				...
				width="30"
				height="30"
				class="image-rendering-pixelated w-10 h-10"
			/>
			{#if !isMobile}
				thefirey33
			{/if}
	...
	{#if showTurkiye}
		<LinkButton linkTowards="/turkiye">hmmm... something random here?</LinkButton>
	{/if}
